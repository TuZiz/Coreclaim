...
public final class ClaimPersistenceRepository {
    ...
    private final ClaimPermissionMigrationRepository permissionMigrationRepository;

    public ClaimPersistenceRepository(ClaimRuntime runtime) {
        this.runtime = runtime;
        this.permissionMigrationRepository = new ClaimPermissionMigrationRepository(runtime);
    }
    ...
    public void migrateMergedPermissionData() {
        permissionMigrationRepository.migrateMergedPermissionData();
    }
