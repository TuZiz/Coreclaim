...
public final class ClaimPersistenceRepository {
        ...
        runtime.databaseManager().query(
            ...
            resultSet -> {
                while (resultSet.next()) {
                    ...
                    claim.setMemberSettings(playerId, memberSettingsFromResultSet(resultSet));
                }
                return null;
            }
        );
    ...
    private ClaimMemberSettings memberSettingsFromResultSet(ResultSet resultSet) throws SQLException {
